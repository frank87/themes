			...
			foreach ( $posts as $post ) {
				...
				<li>
					...
					<div class="facebook_data">
						<?php //echo '' . make_clickable(esc_html($post->message)); ?>
						<br><br>
					</div>
				
					<div class="facebook_time tbWow fadeIn">
						<a target="_blank" href="<?php echo esc_url($post_link); ?>"><?php echo esc_html__('Read more &raquo;', 'liberty'); ?></a>
						<?php echo twitter_time_diff($uTime, current_time('timestamp')); ?> ago
					</div>
		...
		<ul class="slides">
			...
			foreach ( $posts as $post ) {
				...
				<li>
					...
					<div class="facebook_data">
						<?php //echo '' . make_clickable(esc_html($post->message)); ?>
						<br><br><a target="_blank" href="<?php echo esc_url($post_link); ?>"><?php echo esc_html__('Read more &raquo;', 'liberty'); ?></a>
					</div>
