	...
	if ( ! empty( $fw_social_facebook ) ) {
		...
		class Widget_Facebook_Page_Stream extends WP_Widget {
			...
			function __construct() {
				...
				parent::__construct( false, esc_html__( 'Facebook', 'liberty' ), $widget_ops );
			}
			...
			function form( $instance ) {
				...
				<p>
					<label
						for="<?php echo '' . $this->get_field_id( 'title' ); ?>"><?php esc_html_e( 'Title', 'liberty' ); ?> </label>
				...
				<p>
					<label
						for="<?php echo '' . $this->get_field_id( 'page_id' ); ?>"><?php esc_html_e( 'Page ID:', 'liberty' ); ?> </label>
				...
				<p>
					<label
						for="<?php echo '' . $this->get_field_id( 'number' ); ?>"><?php esc_html_e( 'Number of posts:', 'liberty' ); ?>
						:</label>
