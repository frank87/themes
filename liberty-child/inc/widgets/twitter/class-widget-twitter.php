...
if ( defined( 'FW' ) && function_exists( 'fw_ext_social_twitter_get_connection' ) && function_exists( 'curl_exec' ) ) {
	...
	class Widget_Twitter extends WP_Widget {
		...
		function __construct() {
			...
			parent::__construct( false, esc_html__( 'Twitter', 'liberty' ), $widget_ops );
		}
		...
		function form( $instance ) {
			...
			?>
			<p>
				<label for="<?php echo '' . $this->get_field_id( 'title' ); ?>"><?php esc_html_e( 'Title', 'liberty' ); ?> </label>
				<input type="text" name="<?php echo '' . $this->get_field_name( 'title' ); ?>"
				       value="<?php echo esc_attr( $instance['title'] ); ?>" class="widefat"
				       id="<?php $this->get_field_id( 'title' ); ?>"/>
			</p>
			<p>
				<label for="<?php echo '' . $this->get_field_id( 'user' ); ?>"><?php esc_html_e( 'User', 'liberty' ); ?> :</label>
			...
			<p>
				<label for="<?php echo '' . $this->get_field_id( 'number' ); ?>"><?php esc_html_e( 'Number of tweets', 'liberty' ); ?>
					:</label>
	        ...
	        <p>
	        	<label for="<?php echo '' . $this->get_field_id('type_of_widget'); ?>"><?php esc_html_e('Type of list:', 'liberty'); ?></label>
				<select class="widefat" name='<?php echo '' . $this->get_field_name('type_of_widget'); ?>' id='<?php echo '' . $this->get_field_id('type_of_widget'); ?>'>
					<option title='Regular' value='regular' <?php if ($type_of_widget == 'regular') {echo ' selected="selected"';} ?>><?php esc_html_e( 'Regular', 'liberty' ); ?></option>
					<option title='Slider' value='slider' <?php if ($type_of_widget == 'slider') {echo ' selected="selected"';} ?>><?php esc_html_e( 'Slider', 'liberty' ); ?></option>
				</select>
	        </p>
			<p>
			    ...
			    <label for="<?php echo '' . $this->get_field_id( 'showAvatar' ); ?>"><?php esc_html_e( 'Display avatar image', 'liberty' ); ?></label>
			</p>
			<p>
			    ...
			    <label for="<?php echo '' . $this->get_field_id( 'border_rad' ); ?>"><?php esc_html_e( 'Circular Avatar image', 'liberty' ); ?></label>
			</p>          
	        <p>
	        	<label for="<?php echo '' . $this->get_field_id('avatarSize'); ?>"><?php esc_html_e('Avatar Size:', 'liberty'); ?></label>
				<select class="widefat" name='<?php echo '' . $this->get_field_name('avatarSize'); ?>' id='<?php echo '' . $this->get_field_id('avatarSize'); ?>'>
					<option title='Mini' value='mini' <?php if ($avatarSize == 'mini') {echo ' selected="selected"';} ?>><?php esc_html_e( 'Mini', 'liberty' ); ?></option>
					<option title='Normal' value='normal' <?php if ($avatarSize == 'normal') {echo ' selected="selected"';} ?>><?php esc_html_e( 'Normal', 'liberty' ); ?></option>
					<option title='Bigger' value='bigger' <?php if ($avatarSize == 'bigger') {echo ' selected="selected"';} ?>><?php esc_html_e( 'Bigger', 'liberty' ); ?></option>
				</select>
	        </p>
		<?php
		}
