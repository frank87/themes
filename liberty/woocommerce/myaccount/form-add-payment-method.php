	...
	<form id="add_payment_method" method="post">
		<div id="payment" class="woocommerce-Payment">
			...
			<div class="form-row">
				...
				<input type="submit" class="woocommerce-Button woocommerce-Button--alt button alt btn btn-tb-primary" id="place_order" value="<?php esc_attr_e( 'Add Payment Method', 'liberty' ); ?>" />
				<input type="hidden" name="woocommerce_add_payment_method" id="woocommerce_add_payment_method" value="1" />
			</div>
		</div>
	</form>
<?php else : ?>
	<p><?php esc_html_e( 'Sorry, it seems that there are no payment methods which support adding a new payment method. Please contact us if you require assistance or wish to make alternate arrangements.', 'liberty' ); ?></p>
<?php endif; ?>