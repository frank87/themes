...
if (!function_exists('liberty_fw_get_db_post_option')) {
	function liberty_fw_get_db_post_option($data) {
		if (function_exists('fw_get_db_post_option')) {
			return fw_get_db_post_option($data);
		} else {
			return false;
		}
	}
...
class Theme_Includes
{
	...
	public static function init()
	{
		 ...
		 */
		{
			self::include_child_first('/php/fw/helpers.php');
			self::include_child_first('/php/fw/hooks.php');
			self::include_child_first('/php/fw/extensions.php');
			self::include_all_child_first('/php/fw/includes');
			self::include_child_first('/php/widget-areas.php');
			self::include_child_first('/php/liberty_helpers.php');
			self::include_child_first('/admin/options.php');
			self::include_child_first('/php/social-buttons.php');
			self::include_child_first('/php/custom-scripts.php');
			self::include_child_first('/php/layout-functions.php');
			self::include_all_child_first('/php/special');
			/*self::include_all_child_first('/php/widgets');*/
	...
	{
		self::include_child_first('/enqueue.php');
	}
	...
	{
		self::include_child_first('/php/menu-locations.php');
	}
