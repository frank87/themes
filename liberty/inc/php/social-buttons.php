...
**/
if (!function_exists('liberty_social_buttons')) :

function liberty_social_buttons($class = '', $type = 1, $animation = 0) {
	...
	$social_link_email = liberty_default_array($liberty_theme_options, 'promo-text-email', FALSE);
	...
	$social_link_facebook = liberty_default_array($liberty_theme_options, 'promo-text-facebook', FALSE);
	...
	$social_link_twitter = liberty_default_array($liberty_theme_options, 'promo-text-twitter', FALSE);
	...
	$social_link_instagram = liberty_default_array($liberty_theme_options, 'promo-text-instagram', FALSE);
	...
	$social_link_linkedin = liberty_default_array($liberty_theme_options, 'promo-text-linkedin', FALSE);
	...
	$social_link_googleplus = liberty_default_array($liberty_theme_options, 'promo-text-googleplus', FALSE);
	...
	$social_link_pinterest = liberty_default_array($liberty_theme_options, 'promo-text-pinterest', FALSE);
	...
	$social_link_flickr = liberty_default_array($liberty_theme_options, 'promo-text-flickr', FALSE);
	...
	$social_link_youtube = liberty_default_array($liberty_theme_options, 'promo-text-youtube', FALSE);
	...
	$social_link_vimeo = liberty_default_array($liberty_theme_options, 'promo-text-vimeo', FALSE);
