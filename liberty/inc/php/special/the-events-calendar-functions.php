...
if ( function_exists( 'tribe_is_event') ) {
	...
	if (!function_exists('liberty_tribe_events_the_previous_month_link')) :
		function liberty_tribe_events_the_previous_month_link() {
			$html = '';
			...
			echo apply_filters( 'liberty_tribe_events_the_previous_month_link', $html );
		}
	endif;

	if (!function_exists('liberty_tribe_events_the_next_month_link')) :
		function liberty_tribe_events_the_next_month_link() {
			$html = '';
			...
			echo apply_filters( 'liberty_tribe_events_the_next_month_link', $html );
		}
	endif;
	...
	if ( ! function_exists( 'liberty_tribe_the_day_link' ) ) {
		/**
		 ...
		 * @return void
		 **/
		function liberty_tribe_the_day_link( $date = null, $text = null ) {
			$html = '';
			...
			echo apply_filters( 'liberty_tribe_the_day_link', $html );
		}
	}
	...
	if (!function_exists('change_tribe_json_tooltip_thumbnail')) :
		function change_tribe_json_tooltip_thumbnail( $json ) {
			...
			if ( ! empty( $json['imageTooltipSrc'] ) ) {
				...
				$thumbnail_atts = wp_get_attachment_image_src( $thumb_id, 'liberty-wide-s-thumbnail' );
