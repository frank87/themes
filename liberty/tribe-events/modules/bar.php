...
$show_tec_bar = liberty_default_array($liberty_theme_options, 'tec-show-bar', 'no');
...
<div id="tribe-events-bar">
	...
	<form id="tribe-bar-form" class="tribe-clearfix" name="tribe-bar-form" method="post" action="<?php echo esc_attr( $current_url ); ?>">
		...
		<div id="tribe-bar-collapse-toggle" <?php if ( count( $views ) == 1 ) { ?> class="tribe-bar-collapse-toggle-full-width"<?php } ?>>
			<?php esc_html_e( 'Find Events', 'liberty' ) ?><span class="tribe-bar-toggle-arrow"></span>
		</div>
		...
		<div id="tribe-bar-views">
			<div class="tribe-bar-views-inner tribe-clearfix">
				<h3 class="tribe-events-visuallyhidden"><?php esc_html_e( 'Event Views Navigation', 'liberty' ) ?></h3>
				<label><?php esc_html_e( 'View As', 'liberty' ); ?></label>
		...
		<div class="tribe-bar-filters">
			<div class="tribe-bar-filters-inner tribe-clearfix">
				...
				<div class="tribe-bar-submit">
					<input class="tribe-events-button tribe-no-param btn btn-tb-primary" type="submit" name="submit-bar" value="<?php esc_html_e( 'Find Events', 'liberty' ) ?>" />
