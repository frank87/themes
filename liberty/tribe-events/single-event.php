	...
	<?php while ( have_posts() ) :  the_post(); ?>
		...
		if ($archiveTitlePosition == 'below') :
			if ($post_thumbnail_id) {
				liberty_post_thumbnail($postLink, $postTitle, $post_thumbnail_id, $featuredImageSize, $archiveImageType, 0, $showDatebox, 1);
		...
		<?php the_title( '<h1 class="tribe-events-single-event-title summary entry-title title-with-spacer">', '</h1>' ); ?>
