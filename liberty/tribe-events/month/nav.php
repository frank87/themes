...
<h3 class="tribe-events-visuallyhidden"><?php esc_html_e( 'Calendar Month Navigation', 'liberty' ) ?></h3>

<ul class="tribe-events-sub-nav">
	<li class="tribe-events-nav-previous">
		<?php liberty_tribe_events_the_previous_month_link(); ?>
	</li>
	<!-- .tribe-events-nav-previous -->
	<li class="tribe-events-nav-next">
		<?php liberty_tribe_events_the_next_month_link(); ?>
	</li>
