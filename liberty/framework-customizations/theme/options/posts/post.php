...
$options = array(
	'main' => array(
		'title'   => esc_html__( 'Post Options', 'liberty' ),
		'type'    => 'box',
		'options' => array(
			'slogan'=> array(
			...
			'related_switch'                    => array(
				'label'        => esc_html__( 'Show related posts?', 'liberty' ),
				'type'         => 'switch',
				'right-choice' => array(
					'value' => 'yes',
					'label' => esc_html__( 'Yes', 'liberty' )
			...
			'related_subtitle'=> array(
				'label' => esc_html__( 'Related Posts Subtitle', 'liberty' ),
				'type'  => 'text',
				'value' => esc_html__('Related Posts', 'liberty'),
			),	
		),
	),
	'side' => array(
