...
<div id="<?php echo esc_attr($custom_id); ?>" class="tb-column col-xs-12 <?php echo esc_attr($atts['tablet']); ?> <?php echo '' . $id_to_class[$atts['width']]; ?> <?php echo esc_attr($custom_class); ?> <?php echo esc_attr($atts['default_padding']); ?> " >
    <div <?php echo  /* data validated already */  $style; ?> class="<?php echo esc_attr($centered); ?> <?php echo esc_attr($xs_class); ?>">
