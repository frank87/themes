...
$body_typo = liberty_default_array($liberty_theme_options, 'tb-body-typography', '16px');

$body_size = str_replace('px', '', $body_typo['font-size']);

?>

<div class="liberty_counter" style="font-size: <?php echo liberty_px_to_em($body_size, intval($font_size)); ?>em; line-height: <?php echo intval($font_line); ?>px; padding:  <?php echo intval($padding); ?>px 0; color: <?php echo esc_attr($font_color); ?>;">
	<?php if ($text_before) : ?>
