...
$title = isset($atts['title']) ? $atts['title'] : esc_html__('Upcoming Events', 'liberty');
$img = $atts['img_spacer'];
$button_label = isset($atts['button_label']) ? $atts['button_label'] : esc_html__('View More', 'liberty');
